...
public class JPushUtil {
    ...
    private static PushResult push(Platform platform, Audience audience, Notification notification, Message message) {
        ...
        // 3、创建PushPayload
        //PushPayload payload = builder.build();  //默认只能推测试环境
        PushPayload payload = builder.setOptions(Options.newBuilder().setApnsProduction(true).build()).build();
